...
<main class="site-main container">
    ...
    <?php
    // Main Section Category ID from Customizer (fallback to category ID 1)
    $main_cat_id = get_theme_mod('main_section_category', 1);
            ...
            <?php else : ?>
                ...
                <article class="main-small-post">
                    <a href="<?php the_permalink(); ?>">
                        ...
                        <?php else : ?>
                            <img src="https://via.placeholder.com/150x150?text=No+Image" alt="<?php the_title(); ?>">
                        <?php endif; ?>
                        <h3><?php the_title(); ?></h3>
                    </a>
                </article>
